...
public class PresenceService {
    ...
    private record Seen(Instant at, boolean ordering) {}
    ...
    public void heartbeat(Long branchId, String qrKey, String sessionId, boolean ordering) {
        ...
        store.computeIfAbsent(branchId, b -> new ConcurrentHashMap<>())
                ...
                .put(sessionId, new Seen(Instant.now(), ordering));
