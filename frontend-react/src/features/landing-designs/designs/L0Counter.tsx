...
const C0 = {
  ar: {
    ...
    eyebrow: 'Serva — للمقاهي والأنشطة الغذائية في عُمان',
    ...
    closeH: 'ضع Serva على طاولاتك.', closeP: 'أنشئ حسابك وأكمل خطوات التسجيل والدفع بنفسك.',
  ...
  en: {
    ...
    eyebrow: 'Serva — for cafés and food businesses in Oman',
    ...
    closeH: 'Put Serva on your tables.', closeP: 'Create your account and complete onboarding yourself.',
