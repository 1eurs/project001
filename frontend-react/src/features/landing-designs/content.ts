...
// Arabic-first (the product targets Omani food trucks & cafés), English ready.
// ============================================================================
...
export const COPY = {
  ar: {
    ...
    lead: 'منصّة عربية أولاً للطلب عبر رمز QR — لعربات الطعام والمقاهي في عُمان. يمسح الزبون الرمز، يتصفّح القائمة، ويطلب من مكانه.',
    ...
    howLbl: 'كيف يعمل',
    steps: [
      { t: 'امسح الرمز', d: 'رمز QR على شبّاك العربة أو الطاولة يفتح القائمة فوراً في المتصفح — دون أي تنزيل.' },
    ...
    features: [
      ...
      { i: '🔳', t: 'رموز QR', d: 'للعربة أو لكل طاولة — أنشئ واطبع.' },
    ...
    demoDash: 'لوحة العربة', demoDashC: 'شاشة التحضير والإدارة',
    reqLbl: 'اطلب حسابك', reqH: 'ابدأ مع عربتك اليوم.',
    reqP: 'اترك بياناتك ونتواصل معك لتجهيز حسابك أو عرضٍ مباشر — خلال يوم عمل.',
    form: { cafe: 'اسم العربة / المقهى', name: 'اسمك', phone: 'رقم الجوال', city: 'المدينة', note: 'ملاحظة (اختياري)', send: 'أرسل الطلب', sending: 'جارٍ الإرسال…', okh: 'وصلنا طلبك ✓', okp: 'شكراً لك — سنتواصل معك قريباً.' },
    foot: { tagline: 'طلبك على بُعد مسحة واحدة.', contact: 'تواصل', rights: 'جميع الحقوق محفوظة', made: 'صُنع لعربات ومقاهي عُمان' },
  ...
  en: {
    ...
    sub: 'No app. No queue.',
    lead: 'An Arabic-first QR ordering platform for Omani food trucks & cafés. Guests scan, browse the menu, and order right from their seat.',
    ...
    howLbl: 'How it works',
    steps: [
      { t: 'Scan the code', d: 'A QR on the truck window or table opens the menu instantly in the browser — no download.' },
    ...
    features: [
      ...
      { i: '🔳', t: 'QR codes', d: 'For the truck or each table — generate & print.' },
    ...
    demoDash: 'Truck dashboard', demoDashC: 'Prep display & management',
    reqLbl: 'Request access', reqH: 'Start with your truck today.',
    reqP: 'Leave your details and we’ll set up your account or a live demo — within one business day.',
    form: { cafe: 'Truck / café name', name: 'Your name', phone: 'Phone number', city: 'City', note: 'Note (optional)', send: 'Send request', sending: 'Sending…', okh: 'Got your request ✓', okp: 'Thank you — we’ll be in touch shortly.' },
    foot: { tagline: 'Your order, one scan away.', contact: 'Contact', rights: 'All rights reserved', made: 'Made for Omani trucks & cafés' },
