...
export default function TrackPage() {
  ...
  const { slug, branchId, tableToken } = useVenue();
  ...
  const menuPath = slug ? (tableToken ? `/r/${slug}/b/${branchId}/t/${tableToken}` : branchId != null ? `/r/${slug}/b/${branchId}` : `/r/${slug}`) : '/';

  if (isLoading || !o) return <div className="cust-bg"><div className="phone"><div className="center"><div className="spinner" /></div></div></div>;
